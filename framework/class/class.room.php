...
class Room{
	...
	public function update_room($rnumber,$rtype,$rdesc,$rprice,$rfloor,$id){
		...
		$q->execute(array(':room_number'=>$rnumber, ':room_type'=>$rtype, ':room_desc'=>$rdesc,':room_price'=>$rprice,':room_floor'=>$rfloor, ':room_id'=>$id));
		return true;
	}
